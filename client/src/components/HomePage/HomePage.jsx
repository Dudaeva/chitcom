    ...
    <>
      ...
      <Grid container className={classes.main}>
        <Grid className={classes.container}>
          ...
          <Grid>
            <Box width={933} height={300} ml={14} mt={4} borderRadius="10px" pt = {8} style = {{backgroundColor:"#ffd95c", color:'black'}}>
                <h1>Lorem ipsum
                <Typical
                  steps={["dolor sit", 1000, " amet consectetur adipisicing elit."]}
                  loop={3}
                  wrapper="p"
                />
                </h1>
